...
lll oHash[] = { 0, 991154056, 319197064, 1959725865, 1938065277, 2088086459 };
...
inline void prepareInput() {
    if (batch == 1) {
        InputN = { 5, 5 };
        InputU = { {5, 1, 4, 3}, {1, 5, 3, 2} };
        InputV = { {1, 4, 2, 2}, {2, 3, 2, 4} };
    }
    else if (batch == 2) {
        InputN = { 8, 7 };
        InputU = { {1, 7, 3, 6, 5, 2, 8}, {7, 5, 6, 1, 3, 4} };
        InputV = { {7, 3, 6, 5, 2, 8, 4}, {5, 6, 1, 3, 4, 2} };
    }
    else {
    ...
    for (fout << nTest[batch] << "\n", test = 0; test < nTest[batch]; ++test) {
        ...
        for (lll i = 0; i < InputN[test]; InputA[test][++i].clear());
